...
from _telas.desingner.tefopr import TEFOPR
from _regras.sebd.refopr import REFOPR


class EFOPR(TEFOPR):

    def __init__(self, *args, **kwargs):
        super(EFOPR, self).__init__(*args, **kwargs)
        self.lista = []
        self.pn_lista.Hide()
        self.pn_dados.Show()
    ...
    def ac_selecionar(self, event):
        self.operacao = str(self.gd_resultado.GetCellValue(self.gd_resultado.GetGridCursorRow(), 0))
