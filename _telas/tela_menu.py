...
class FrmMenu ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.tc_executar = wx.TextCtrl( self.m_toolBar1, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_toolBar1.AddControl( self.tc_executar )
		self.bt_executar = self.m_toolBar1.AddLabelTool( wx.ID_ANY, u"tool", wx.Bitmap( u"../icons/ac_executar_16x16.png", wx.BITMAP_TYPE_ANY ), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, wx.EmptyString, None ) 
