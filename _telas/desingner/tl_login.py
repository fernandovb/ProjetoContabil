...
class FrmLogin ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.TxHost = wx.TextCtrl( self, wx.ID_ANY, u"localhost", wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_TAB )
		...
		self.TxUser = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_TAB )
		...
		self.TxSenha = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_PASSWORD|wx.TE_PROCESS_TAB )
		...
		self.TxDatabase = wx.TextCtrl( self, wx.ID_ANY, u"fvb_db", wx.DefaultPosition, wx.DefaultSize, wx.TE_PROCESS_TAB )
		...
		self.tb_mensagem = wx.TextCtrl( sbSizer3.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
		...
		# Connect Events
		self.Bind( wx.EVT_CLOSE, self.on_encerrar )
