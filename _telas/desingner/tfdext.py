...
class ALCCON ( wx.Dialog ):
	
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Procurar conta", pos = wx.DefaultPosition, size = wx.Size( 491,366 ), style = wx.DEFAULT_DIALOG_STYLE )
		
		self.SetSizeHintsSz( wx.DefaultSize, wx.DefaultSize )
		
		lay_body = wx.BoxSizer( wx.VERTICAL )
		
		self.pn_dados = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		lay_dados = wx.BoxSizer( wx.HORIZONTAL )
		
		lay_titulos = wx.BoxSizer( wx.VERTICAL )
		
		self.lb_conta_contabil = wx.StaticText( self.pn_dados, wx.ID_ANY, u"Conta contábil:", wx.DefaultPosition, wx.Size( 150,26 ), wx.ALIGN_RIGHT )
		...
		lay_body.Add( self.pn_dados, 1, wx.EXPAND |wx.ALL, 5 )
		
		self.pn_lista = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.TAB_TRAVERSAL )
		self.pn_lista.Hide()
		...
		lay_lista.Add( self.gd_resultado, 0, wx.ALL|wx.EXPAND, 5 )
		
		
		self.pn_lista.SetSizer( lay_lista )
		self.pn_lista.Layout()
		lay_lista.Fit( self.pn_lista )
		lay_body.Add( self.pn_lista, 1, wx.EXPAND |wx.ALL, 5 )
		
		self.pn_botoes = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.STATIC_BORDER )
		...
		lay_body.Add( self.pn_botoes, 0, wx.EXPAND |wx.ALL, 5 )
		...
		# Connect Events
		self.bt_confirmar.Bind( wx.EVT_BUTTON, self.ac_confirmar )
		self.bt_localizar.Bind( wx.EVT_BUTTON, self.ac_localizar )
		self.bt_cancelar.Bind( wx.EVT_BUTTON, self.ac_cancelar )
